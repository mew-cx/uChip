...
const PinDescription g_APinDescription[]=
{
  ...
  { PORTA,   3, PIO_DIGITAL, (PIN_ATTR_DIGITAL), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_3 }, // ADC/AIN[1]	--P14
  { PORTA,   5, PIO_DIGITAL, (PIN_ATTR_DIGITAL), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_5 }, // ADC/AIN[13]	--P15
  // 16 Vext voltage selector
  { PORTA,  15, PIO_TIMER, (PIN_ATTR_DIGITAL), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // Output Only --5V/3V3_SELECTOR
  
  // 17..24 - Analog pins
  // --------------------
  { PORTA,   8, PIO_ANALOG, 0, ADC_Channel16, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NMI}, // ADC/AIN[16]	--P2
  { PORTA,  10, PIO_ANALOG, 0, ADC_Channel18, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_10	 }, // ADC/AIN[18]	--P3
  { PORTA,   9, PIO_ANALOG, 0, ADC_Channel17, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_9 	 }, // ADC/AIN[17]	--P4
  { PORTA,  11, PIO_ANALOG, 0, ADC_Channel19, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_11	 }, // ADC/AIN[19]	--P5
  ...
  { PORTA,   3, PIO_ANALOG, PIN_ATTR_ANALOG, ADC_Channel1, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_3 }, // ADC/AIN[1]	--P14
  { PORTA,   5, PIO_ANALOG, PIN_ATTR_ANALOG, ADC_Channel5, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_5 }, // ADC/AIN[5]	--P15
  ...
  // 31..34 - SPI pins (ICSP:MISO,SCK,MOSI)
  // ----------------------
  ...
  // 38 (AREF)
  { PORTA, 3, PIO_ANALOG, PIN_ATTR_ANALOG, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // DAC/VREFP --P14
  // ----------------------
